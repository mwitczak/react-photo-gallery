												...
												for (var i = 0; i < this.props.photos.length; i += rowLimit) {
																...
																for (var k = i; k < i + rowLimit; k++) {
																				...
																				if (this.props.photos[k].onClick) {
																								var link = this.props.photos[k].link ? this.props.photos[k].link : '#';
																								photoPreviewNodes.push(_react2['default'].createElement(
																												'div',
																												{ key: k, style: style },
																												_react2['default'].createElement(
																																'a',
																																{ href: link, onClick: this.props.photos[k].onClick, className: 'image' },
																								...
																								photoPreviewNodes.push(_react2['default'].createElement(
																												'div',
																												{ key: k, style: style, className: 'image' },
																												_react2['default'].createElement('img', { src: src,
																																style: { display: 'block', border: 0 },
																																height: commonHeight,
																																width: commonHeight * this.props.photos[k].aspectRatio,
